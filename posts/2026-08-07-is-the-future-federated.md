...
Sovereignty in the EU is now the trend, at least as a conceptual idea. Someone
...
stomachaches and concerns among multiple governments.

Under these conditions, it is a good idea to understand the status of the
mainstream internet services, including the so-called cloud and social networks.
As explained [in a past post](https://lovergine.com/breaking-dependencies-on-bigcos-and-a-us-centric-it-world.html), 
...
offering such services worldwide, they can be enough for European use.

About social networks and instant messaging systems, among others, the situation
...
Like it or not, the only true alternatives for such systems are the fully
[federated services](https://en.wikipedia.org/wiki/Fediverse),
...
But imagine for a moment that all Internet users would like to enter the
federated worlds.

In most cases, the typical federated server hosts a few hundred to a few
...
situation with a good tradeoff between quality of service and efforts/size.

In our hypothesis, such servers would probably be subject to an average load
...
Again and again, my consideration is always the same: it is not only a matter of
...
So, federated services could be the answer for the future, but only by ensuring
...
implication is that the mainstream _bigco_ services will not be threatened by such
...
[the end of the Internet dream](https://lovergine.com/the-web-is-dying-long-live-the-world-wide-web.html), 
which is already threatened by hyperscalers.

To understand the matter, think of Gmail, which is probably the most common
...
I would be happy if social networks moved in such a direction, frankly.

A completely different matter is the AI drama, where I see most of the risk for
...
More and more, I see personal computing in the AI context will consist of
...
fully independent alphabetization policy in this new(?) digital world.

_But maybe this is matter for another post..._
