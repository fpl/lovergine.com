         ...
         (lambda (site title body)
           `((doctype "html")
             (head
              ...
              ;; Apply any stored forced theme before first paint, so
              ;; there's no flash of the wrong colors.  The click
              ;; handling lives in /js/theme-toggle.js.
              (script "(function(){try{var m=localStorage.getItem('theme');if(m==='light'||m==='dark'){document.documentElement.setAttribute('data-theme',m);}}catch(e){}})();")
              ...
              (div (@ (class "container"))
                        ...
                        (ul 
                            (li (h2 (@ (class "site-title"))
                                    (svg (@ (class "site-logo")
                                            ...
                                            (viewBox "0 0 180 180"))
                                         (path (@ (class "balloon-outline")
                                                  (stroke-width "3")
                                                  (d "M25,10 h130 a15,15 0 0 1 15,15 v100 a15,15 0 0 1 -15,15 h-80 l-20,30 v-30 h-30 a15,15 0 0 1 -15,-15 v-100 a15,15 0 0 1 15,-15 z")))
                   ...
                   (div (@ (class "right-box"))
                        ...
                        (button (@ (type "button")
                                   (class "theme-toggle")
                                   (data-mode "auto")
                                   (aria-label "Theme: Auto (follows system) (click to change)")
