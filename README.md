...
- Scripts are based on those written with ❤ by [Dave Thompson](https://github.com/https://git.dthompson.us/haunt.git), [Stephen Lloyd](https://gitlab.com/zosho/somenotes-source) and [Janneke Nieuwenhuizen](https://gitlab.com/janneke/joyofsource.com).
